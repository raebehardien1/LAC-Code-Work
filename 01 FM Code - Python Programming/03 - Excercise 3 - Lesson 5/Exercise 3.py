...
def personalized_greeting(name):
    print (f"Hi"+{name}! Welcomee to Python Function.")
# TODO: Call thee 'personalized_greeting' function with your name
def personalized_greeting(Rae):
    print ("Hi"+ personalized_greeting)
...
def rectangle_angle(length, width):
    return length*width

#TODO: Call the function with length 4 and width 5, and print the result
result = rectangle_angle(4, 5)
print(("The area of a rectangle with  LENGTH OF 4 and wisth of 5 is {area}"))
#------------------------------------------------------------------------------------
...
result = apply_operation(func , num)
    print(f(""))
    return n * 2
